...
public partial class ImportAppDbContext : DbContext
{
    ...
    public ImportAppDbContext(DbContextOptions<ImportAppDbContext> options)
        : base(options)
    {
    }
    ...
    public virtual DbSet<Novi> Novis { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Novi>(entity =>
        {
            ...
            entity.HasOne(d => d.SubCategory).WithMany(p => p.Novis).HasForeignKey(d => d.SubCategoryId);
        });
